...
# We need to find the end of the App component.
# Let's match the last div closures before the return.
...
if "SCENE 3 CONTAINER" not in content:
    # First we need to find the correct ending. Let's see the current ending.
    # It looks like:
    #         </div>
    # </div>
    #     </div>
    ...
    # We will replace all closing divs at the end of the file with the properly formatted ones.
